...
func init() {
	...
	primitive[102] = &Procedure{name: "thread-queue-set!", required: 2, apply: nil, label: 102}
	primitive[101] = &Procedure{name: "thread-queue", required: 1, apply: nil, label: 101}
	primitive[90] = &Procedure{name: "thread-specific-set!", required: 2, apply: nil, label: 90}
	primitive[89] = &Procedure{name: "thread-specific", required: 1, apply: nil, label: 89}
	primitive[88] = &Procedure{name: "thread-name", required: 1, apply: nil, label: 88}
	primitive[87] = &Procedure{name: "thread?", required: 1, apply: nil, label: 87}
	primitive[86] = &Procedure{name: "$make-thread", required: 2, apply: nil, label: 86}
	primitive[85] = &Procedure{name: "$write", required: 2, apply: nil, label: 85}
	primitive[84] = &Procedure{name: "$display", required: 2, apply: nil, label: 84}
	primitive[83] = &Procedure{name: "lookahead-u8", required: 1, apply: nil, label: 83}
	primitive[82] = &Procedure{name: "put-bytevector", required: 2, apply: nil, label: 82}
	primitive[81] = &Procedure{name: "put-u8", required: 2, apply: nil, label: 81}
	primitive[80] = &Procedure{name: "get-u8", required: 1, apply: nil, label: 80}
	primitive[79] = &Procedure{name: "$write-char", required: 2, apply: nil, label: 79}
	primitive[78] = &Procedure{name: "$peek-char", required: 1, apply: nil, label: 78}
	primitive[77] = &Procedure{name: "$read-char", required: 1, apply: nil, label: 77}
	...
	primitive[70] = &Procedure{name: "file-exists?", required: 1, apply: nil, label: 70}
	primitive[69] = &Procedure{name: "current-output-port", required: 0, apply: nil, label: 69}
	primitive[68] = &Procedure{name: "current-input-port", required: 0, apply: nil, label: 68}
	...
	primitive[59] = &Procedure{name: "bytevector?", required: 1, apply: nil, label: 59}
	primitive[58] = &Procedure{name: "$global-set!", required: 2, apply: nil, label: 58}
	primitive[57] = &Procedure{name: "$global-ref", required: 1, apply: nil, label: 57}
	primitive[56] = &Procedure{name: "$cell-set!", required: 2, apply: nil, label: 56}
	primitive[55] = &Procedure{name: "$cell-ref", required: 1, apply: nil, label: 55}
	primitive[54] = &Procedure{name: "$make-cell", required: 1, apply: nil, label: 54}
	primitive[103] = &Procedure{name: "$bytecode-load", required: 1, apply: nil, label: 103}
	primitive[53] = &Procedure{name: "$bytecode-run", required: 3, apply: nil, label: 53}
	primitive[52] = &Procedure{name: "command-line", required: 0, apply: nil, label: 52}
	primitive[51] = &Procedure{name: "exit", required: 1, apply: nil, label: 51}
	primitive[50] = &Procedure{name: "eq?", required: 2, apply: nil, label: 50}
	...
	primitive[43] = &Procedure{name: "string-ref", required: 2, apply: nil, label: 43}
	primitive[42] = &Procedure{name: "string-length", required: 1, apply: nil, label: 42}
	...
	primitive[36] = &Procedure{name: "$bitwise-ior", required: 2, apply: nil, label: 36}
	primitive[35] = &Procedure{name: "denominator", required: 1, apply: nil, label: 35}
	primitive[34] = &Procedure{name: "$cmp", required: 2, apply: nil, label: 34}
	primitive[33] = &Procedure{name: "$-", required: 2, apply: nil, label: 33}
	primitive[32] = &Procedure{name: "$*", required: 2, apply: nil, label: 32}
	primitive[31] = &Procedure{name: "$/", required: 2, apply: nil, label: 31}
	primitive[30] = &Procedure{name: "$+", required: 2, apply: nil, label: 30}
	primitive[29] = &Procedure{name: "$string->number", required: 2, apply: nil, label: 29}
	primitive[28] = &Procedure{name: "$number->string", required: 2, apply: nil, label: 28}
	primitive[27] = &Procedure{name: "integer?", required: 1, apply: nil, label: 27}
	primitive[26] = &Procedure{name: "number?", required: 1, apply: nil, label: 26}
	primitive[25] = &Procedure{name: "vector", required: 0, apply: nil, label: 25}
	primitive[24] = &Procedure{name: "vector-set!", required: 3, apply: nil, label: 24}
	primitive[23] = &Procedure{name: "vector-ref", required: 2, apply: nil, label: 23}
	primitive[22] = &Procedure{name: "vector-length", required: 1, apply: nil, label: 22}
	primitive[21] = &Procedure{name: "make-vector", required: 2, apply: nil, label: 21}
	primitive[20] = &Procedure{name: "vector?", required: 1, apply: nil, label: 20}
	primitive[19] = &Procedure{name: "char-downcase", required: 1, apply: nil, label: 19}
	primitive[18] = &Procedure{name: "char-upcase", required: 1, apply: nil, label: 18}
	primitive[17] = &Procedure{name: "char-whitespace?", required: 1, apply: nil, label: 17}
	primitive[16] = &Procedure{name: "integer->char", required: 1, apply: nil, label: 16}
	primitive[15] = &Procedure{name: "char->integer", required: 1, apply: nil, label: 15}
	primitive[14] = &Procedure{name: "char?", required: 1, apply: nil, label: 14}
	primitive[13] = &Procedure{name: "string->symbol", required: 1, apply: nil, label: 13}
	primitive[12] = &Procedure{name: "symbol->string", required: 1, apply: nil, label: 12}
	primitive[11] = &Procedure{name: "symbol?", required: 1, apply: nil, label: 11}
	primitive[10] = &Procedure{name: "null?", required: 1, apply: nil, label: 10}
	primitive[9] = &Procedure{name: "set-cdr!", required: 2, apply: nil, label: 9}
	primitive[8] = &Procedure{name: "set-car!", required: 2, apply: nil, label: 8}
	primitive[7] = &Procedure{name: "length", required: 1, apply: nil, label: 7}
	primitive[6] = &Procedure{name: "floyd", required: 1, apply: nil, label: 6}
	primitive[5] = &Procedure{name: "cdr", required: 1, apply: nil, label: 5}
	primitive[4] = &Procedure{name: "car", required: 1, apply: nil, label: 4}
	primitive[3] = &Procedure{name: "cons", required: 2, apply: nil, label: 3}
	primitive[2] = &Procedure{name: "pair?", required: 1, apply: nil, label: 2}
	primitive[1] = &Procedure{name: "not", required: 1, apply: nil, label: 1}
	primitive[0] = &Procedure{name: "boolean?", required: 1, apply: nil, label: 0}
}
